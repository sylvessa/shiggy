...
void isr_install(void) {
	isr_func_t isrs[ISR_COUNT] = {isr0,	 isr1,	isr2,  isr3,  isr4,	 isr5,	isr6,  isr7,  isr8,	 isr9,	isr10,
	...
	isr_func_t irqs[IRQ_COUNT] = {irq0, irq1, irq2,	 irq3,	irq4,  irq5,  irq6,	 irq7,
...
void isr_handler(registers_t r) { printf("received interrupt: %d\n%s\n", r.int_no, exception_messages[r.int_no]); }

void register_interrupt_handler(nat8 n, isr_handler_t handler) { interrupt_handlers[n] = handler; }
